$(document).ready(() => {
    $("#submit").click((e) => {
        ...
        isValid = addError(username, "Username cannot be empty")
        isValid = isValid & addError(email, "Email cannot be empty")

        isValid = isValid & addError(password, "Password cannot be empty")
        isValid = isValid & addError(password2, "Confirm Password cannot be empty")
